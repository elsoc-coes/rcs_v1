...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-sexo-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-edad-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-educacion-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/consti-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-consti-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-consti-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-convencion-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/leg-dem-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-leg-dem-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-leg-dem-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/satis-dem-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-satis-dem-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-satis-dem-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/autoritarismo-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-autoritarismo-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/posicion-pol-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-posicion-pol-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-posicion-pol-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-centro-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-centro-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-sin-posicion-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-sin-posicion-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/interes-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-interes-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-interes-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/partido-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-partido-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-partido-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/id-partido-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-id-partido-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-id-partido-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/involv-pol-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-involv-poli-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-pol-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-conf-pol-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-conf-pol-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-conf-inst-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-mov-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-mov-tipo-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-mov-tipo-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/parti-mov-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-parti-mov-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/op-valores-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-op-valores-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-op-valores-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/op-contingente-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-op-contingente-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-justviolencia1-ola-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-justviolencia1-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-justviolencia1-ola-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-justviolencia2-ola-ola-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/graf-justviolencia2-ola-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/confli-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/confli-olas-voto-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/confli-zona-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/crim-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/crim-olas-voto-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/crim-zona-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/inseg-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/inseg-voto-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/inseg-zona-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-olas-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-voto-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-zona-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-part-1} \end{center}

\hypertarget{conflicto-induxedgena}{%
\subsection{Conflicto indígena}\label{conflicto-induxedgena}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-indigena-olas-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf-migratorio-olas-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/salud-bienestar-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/salud-bienestar-olas-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/depre-plebiscito-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/depre-olas-sexo-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/depre-olas-sexo-2-1} \end{center}

\hypertarget{covid-19}{%
\subsection{Covid 19}\label{covid-19}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/cuarentenas-olas-salida-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/econsalud-olas-tipovotante-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/econsalud-olas-tipovotante-2-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/econsalud-olas-tipovotante-3-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/laboral-historica-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/laboral-plebiscito-1} \end{center}

\hypertarget{confianza-interpersonal}{%
\subsection{Confianza interpersonal}\label{confianza-interpersonal}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf inter voto-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/conf inter perfiles-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-30-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-31-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-32-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-33-1} \end{center}

\hypertarget{percepciuxf3n-de-desigualdad}{%
\subsection{Percepción de desigualdad}\label{percepciuxf3n-de-desigualdad}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-34-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-35-1} \end{center}

\hypertarget{identidad-nacional}{%
\subsection{Identidad Nacional}\label{identidad-nacional}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-36-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-37-1} \end{center}

\hypertarget{clase-social-subjetiva}{%
\subsection{Clase social subjetiva}\label{clase-social-subjetiva}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-38-1} \end{center}

\hypertarget{movilidad-social}{%
\subsection{Movilidad social}\label{movilidad-social}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-39-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-40-1} \end{center}

\hypertarget{seguridad-econuxf3mica-ahorros}{%
\subsection{Seguridad Económica Ahorros}\label{seguridad-econuxf3mica-ahorros}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-41-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-42-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-43-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-44-1} \end{center}
...
\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-45-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-46-1} \end{center}

\hypertarget{salarios-justos}{%
\subsection{Salarios Justos}\label{salarios-justos}}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-47-1} \end{center}

\begin{center}\includegraphics{reporte-elsoc_files/figure-latex/unnamed-chunk-48-1} \end{center}
