...
<!-- ```{r} -->
<!-- print(readRDS(file.path('..', 'inputs', 'cohesion social', 'relaciones-sociales', 'graficos', 'gf_cs_rsi_altruismo_evolucion.RDS'))) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- print(readRDS(file.path('..', 'inputs', 'cohesion social', 'relaciones-sociales', 'graficos', 'gf_cs_rrd_homo_evolucion.RDS'))) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- print(readRDS(file.path('..', 'inputs', 'cohesion social', 'relaciones-sociales', 'graficos', 'gf_cs_rrd_mapu_evolucion.RDS'))) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- print(readRDS(file.path('..', 'inputs', 'cohesion social', 'relaciones-sociales', 'graficos', 'gf_cs_rrd_inmig_evolucion.RDS'))) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- print(readRDS(file.path('..', 'inputs', 'cohesion social', 'relaciones-sociales', 'graficos', 'gf_cs_lazos_evolucion.RDS'))) -->
<!-- ``` -->


```{r}
print(readRDS(file.path('..', 'inputs', 'cohesion social', 'relaciones-sociales', 'graficos', 'gf_cs_lazos_perfiles.RDS')))
```
...
elsoc_long_2016_2022 %>% 
  ...
  geom_line() +
  ggtitle(label = '"Me siento orgulloso de ser chileno/a", según perfil de votante', subtitle = 'Porcentaje De acuerdo o Totalmente de acuerdo') +
...
elsoc_long_2016_2022 %>% 
  ...
  geom_point(size = 1.75) + 
  geom_line() +
  ggtitle(label = '"Me identifico con Chile", según ola y perfil de participación', subtitle = 'Porcentaje De acuerdo o Totalmente de acuerdo') +
  scale_y_continuous(labels = scales::percent, 
                     limits = c(.75, 1)) +
  ylab(label = NULL) +
  xlab(label = NULL) +
