...
elsoc_long_2016_2022 %>% 
  ...
  geom_line() +
  ggtitle(label = 'Confianza interpersonal, según perfil de votante', 
          subtitle = 'Porcentaje que responde que "Casi siempre se puede confiar en las personas"') +
...
elsoc_long_2016_2022 %>% 
  ...
  geom_point(size = 1.75) + 
  geom_line() +
  ggtitle(label = 'Aceptación de la diversidad, según perfil de votante', 
          subtitle = 'Porcentaje De acuerdo o Totalmente de acuerdo, en promedio, con la aceptación de la diversidad*') +
  scale_y_continuous(labels = scales::percent, 
                     limits = c(0, 1)) +
  ylab(label = NULL) +
  xlab(label = NULL) +
...
elsoc_long_2016_2022 %>% 
  ...
  geom_point(size = 1.75) + 
  geom_line() +
  ggtitle(label = 'Percepción de justicia, según perfil de votante', 
          subtitle = 'Porcentaje de acuerdo o muy de acuerdo, en promedio, con Índice de percepción de justicia*') +
  scale_y_continuous(labels = scales::percent, 
                     limits = c(0, 1)) +
  ylab(label = NULL) +
  xlab(label = NULL) +
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = '*Indicador construido con respuesta promedio al grado de acuerdo con "Las personas son recompensadas\npor sus esfuerzos" y "Las personas son recompensadas por su inteligencia"')
...
elsoc_long_2016_2022 %>% 
  ...
  ggtitle(label = 'Vínculo territorial, según perfil de votante', 
          subtitle = 'Porcentaje de acuerdo o muy de acuerdo, en promedio, con Índice de Vínculo territorial*') +
  scale_y_continuous(labels = scales::percent, 
                     limits = c(0, 1)) +
  ylab(label = NULL) +
  xlab(label = NULL) +
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
    labs(caption = '*Indicador construido con respuesta promedio al grado de acuerdo con "Este es el barrio ideal para mi", "Me siento\nintegrado/a en este barrio", "Me identifico con la gente de este barrio" y "Este barrio es parte de mi"')
...
elsoc_long_2016_2022 %>% 
  ...
  ggtitle('Conflictividad barrial alta, según año y tipo de votante',
      ...
      labs(caption = '*Indicador construido con respuesta promedio a la frecuencia en que ha tenido problemas con vecinos por\n"Ruidos molestos", "Tenencia irresponsable de mascotas", "Amenazas, insulos u ofensas" y "Basura"')
...
print(readRDS("../inputs/cohesion social/bienestar/gf_cs_bienestar_satisfaccion_perfiles.RDS") +
          ggtitle('Satisfacción con la vida, según año y tipo de votante',
