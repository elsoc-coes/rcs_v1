...
```{r , fig.cap = 'Satisfacción con la vida, ideal de vida y salud subjetiva, según ola'}
...
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion %in% c(1,33), ola == 5)  %>%
...
```{r depre-olas-sexo-2, fig.cap = 'Porcentaje que presenta síntomas de depresión moderados a severos, según voto y ola'}
...
```{r cuarentenas-olas-salida, fig.cap = 'Porcentaje que está de acuerdo con las cuarentenas según tipo de voto'}
...
```{r econsalud-olas-tipovotante, fig.cap = 'Porcentaje que está de acuerdo con cuarentenas según votante'}
...
```{r econsalud-olas-tipovotante-2, fig.cap = 'Porcentaje que está de acuerdo con priorizar la economía según tipo de voto'}
...
```{r econsalud-olas-tipovotante-3, fig.cap = 'Porcentaje que está de acuerdo con priorizar la economía según votante'}
