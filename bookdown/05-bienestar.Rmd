...
```
```{r depre-olas-sexo, fig.cap = 'Porcentaje que presenta síntomas de depresión moderados a severos, según voto y ola'}
...
```{r econsalud-olas-tipovotante, fig.cap = 'Porcentaje que está de acuerdo con priorizar la economía según tipo de voto}
...
```{r econsalud-olas-tipovotante, fig.cap = 'Porcentaje que está de acuerdo con priorizar la economía según votante}
