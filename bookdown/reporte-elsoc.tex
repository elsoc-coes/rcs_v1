...
\caption{Mediciones de ELSOC}(\#fig:ilust-olas-elsoc)
\end{figure}
...
\caption{Muestreo de ELSOC}(\#fig:ilust-etapas-seleccion)
\end{figure}
...
\caption{(\#tab:tabla-atricion)Atrición de las muestras de ELSOC entre olas}
\centering
...
\caption{(\#tab:tabla-atricion-sexo)Atrición acumulada de ELSOC, según sexo}
\centering
...
\caption{(\#tab:tabla-atricion-edad)Atrición acumulada de ELSOC, según grupo etáreo}
\centering
\begin{tabular}[t]{l|c|c|c|c}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c|}{Muestra lograda en 2022} & \multicolumn{2}{c}{Atrición acumulada} \\
...
\caption{(\#tab:tabla-atricion-educ)Atrición acumulada de ELSOC, según nivel educacional}
\centering
\begin{tabular}[t]{l|c|c|c|c}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c|}{Muestra lograda en 2022} & \multicolumn{2}{c}{Atrición acumulada} \\
...
\caption{(\#tab:tabla-atricion-estrato)Atrición acumulada de ELSOC, según estrato}
\centering
\begin{tabular}[t]{l|c|c|c|c}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c|}{Muestra lograda en 2022} & \multicolumn{2}{c}{Atrición acumulada} \\
...
\caption{Composición de muestra longitudinal: Tramo Edad}(\#fig:graf-edadt-muestra)
\end{figure}
...
\caption{Composición de muestra longitudinal: Sexo}(\#fig:graf-sexo-muestra)
\end{figure}
...
\caption{Composición de muestra longitudinal: Nivel Educacional}(\#fig:graf-educ-muestra)
\end{figure}
...
\caption{Composición de muestra longitudinal: Estrato}(\#fig:graf-estrato-muestra)
\end{figure}
...
\caption{Participación electoral por elección}(\#fig:graf-participacion)
\end{figure}
...
\caption{Tipos de votante}(\#fig:graf-perfiles-3)
\end{figure}
...
\caption{Participación electoral, según tipo de votante}(\#fig:graf-tipo-participacion)
\end{figure}
...
\caption{Autoeficacia política, según tipo de votante}(\#fig:graf-eficacia)
\end{figure}
...
\caption{Participación en marchas o manifestaciones, según tipo de votante}(\#fig:graf-parti-mov-2)
\end{figure}
...
\caption{Sexo, según tipo de votante}(\#fig:graf-sexo-2)
\end{figure}
...
\caption{Tramos etarios en 2022, según tipo de votante}(\#fig:graf-edad-2)
\end{figure}
...
\caption{Nivel educacional en 2022, según tipo de votante}(\#fig:graf-educacion-2)
\end{figure}
...
\caption{Clase social en 2022, según tipo de votante}(\#fig:graf-clase-subj-ingreso)
\end{figure}
...
\caption{Plebiscito de Salida 2022}(\#fig:graf-pleb-salida)
\end{figure}
...
\caption{Preferencias en plebiscito de entrada y salida}(\#fig:graf-alluvial-pleb)
\end{figure}
...
\caption{Preferencias en plebiscito de entrada y salida, según periodo del levantamiento}(\#fig:graf-alluvial-pleb-periodo)
\end{figure}
...
\caption{Preferencias en plebiscito de salida, según tipo de votante}(\#fig:graf-tipo-salida)
\end{figure}
...
\caption{Preferencias de voto en plebiscito de entrada y salida, según tipo de votante}(\#fig:graf-alluvial-pleb-tipo)
\end{figure}
...
\caption{Nueva constitución, según tipo de votante}(\#fig:graf-consti-2)
\end{figure}
...
\caption{Desconfianza en la Convención Constitucional en 2022, según tipo de votante}(\#fig:graf-convencion-2)
\end{figure}
...
\caption{Legitimidad democrática, según tipo de votante}(\#fig:graf-leg-dem-2)
\end{figure}
...
\caption{Preferencia por el autoritarismo, según tipo de votante}(\#fig:graf-autori)
\end{figure}
...
\caption{Satisfacción democrática, según tipo de votante}(\#fig:graf-satis-dem-2)
\end{figure}
...
\caption{Actitudes autoritarias, según tipo de votante}(\#fig:graf-autoritarismo-2)
\end{figure}
...
\caption{Posición política en 2022, según tipo de votante}(\#fig:graf-posicion-pol-2)
\end{figure}
...
\caption{Ausencia de posición política, según tipo de votante}(\#fig:graf-sin-posicion-2)
\end{figure}
...
\caption{Cambios en posición política entre 2019 y 2022, según tipo de votante}(\#fig:graf-cambios-idpol-idpol)
\end{figure}
...
\caption{Interés en la política, según tipo de votante}(\#fig:graf-interes-2)
\end{figure}
...
\caption{Partidismo, según tipo de votante}(\#fig:graf-id-partido-2)
\end{figure}
...
\caption{Involucramiento político, según tipo de votante}(\#fig:graf-involv-poli-2)
\end{figure}
...
\caption{Desonfianza en instituciones políticas, según tipo de votante}(\#fig:graf-conf-pol-2)
\end{figure}
...
\caption{Desconfianza en instituciones políticas, según tipo de votante}(\#fig:graf-conf-pol-2-2)
\end{figure}
...
\caption{Desonfianza en Carabineros, según tipo de votante}(\#fig:graf-carab)
\end{figure}
...
\caption{Actitudes valóricas, según tipo de votante}(\#fig:graf-op-valores-2)
\end{figure}
...
\caption{"Cada persona debiera asegurarse por si mismo su futura pensión para la tercera edad", según tipo de votante}(\#fig:graf-pension)
\end{figure}
...
\caption{"El Estado de Chile, más que los privados, debería ser el principal proveedor de educación", según tipo de votante}(\#fig:graf-educacion)
\end{figure}
...
\caption{Desconfianza hacia los Mapuche, según tipo de votante}(\#fig:desconf-mapuche)
\end{figure}
...
\caption{"La nueva constitución permitirá una mejor relación entre el Estado y los pueblos indígenas en Chile" (2022), según tipo de votante}(\#fig:consti-mapuche)
\end{figure}
...
\caption{Desconfianza hacia inmigrantes, según nacionalidad de migrantes y tipo de votante}(\#fig:desconf-inmigrante)
\end{figure}
...
de inmigrantes al país", según tipo de votante}(\#fig:graf-medidas-inm)
\end{figure}
...
\caption{Inmigración y desempleo, según nacionalidad de migrantes y tipo de votante}(\#fig:ame-realista-proced)
\end{figure}
...
\caption{Inmigración e identidad chilena, según nacionalidad de migrantes y tipo de votante}(\#fig:ame-simbolica-proced)
\end{figure}
...
\caption{Confianza interpersonal, según perfil de votante}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Aceptación de la diversidad, según perfil de votante}(\#fig:indice-diversidad-part)
\end{figure}
...
\caption{Percepción de justicia, según perfil de votante}(\#fig:indice-percjusticia-part)
\end{figure}
...
\caption{Elevada vinculación territorial, según perfil de votante}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{Conflictividad barrial alta, según perfil de votante}(\#fig:confli-olas-part)
\end{figure}
...
\caption{Criminalidad barrial alta, según perfil de votante}(\#fig:crim-olas-part)
\end{figure}
...
\caption{Percepción de inseguridad barrial, según perfil de votante}(\#fig:inseg-part)
\end{figure}
...
\caption{Satisfacción con la vida, según perfil de votante}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Sobrecarga por deudas, según perfil de votante}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Perspectiva de movilidad social ascendente, según perfil de votante}(\#fig:unnamed-chunk-5)
\end{figure}
