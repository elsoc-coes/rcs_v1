...
```{r graf-laboral, fig.cap = 'Situación laboral en 2022, según tipo de votante'}
...
```{r graf-quintil, fig.cap = 'Quintiles de ingreso en 2022, según tipo de votante'}
...
```{r graf-alluvial-pleb, fig.cap = 'Preferencias en plebiscito de entrada y salida, según periodo del levantamiento'}
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  ggtitle('', subtitle = 'De acuerdo o muy de acuerdo con cambiar la constitución')
...
```{r graf-centro-2, fig.cap = 'Posición política de centro, según tipo de votante'}
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  ggtitle('', subtitle = 'Porcentaje que se autoidentifica de centro')
...
elsoc_wide_2016_2022 %>% 
  filter(tipo_atricion == 1) %>% 
  filter(!is.na(pp_3))
  mutate(pos_id_w04 = factor(car::recode(c15_w04, recodes = "0:4 = 1; 5 = 2; 6:10 = 3; 11:12 = 4; c(-888, -999, -777, -666) = 5"),
                         levels = c(1, 2, 3, 4, 5),
                         labels = c('Izquierda', "Centro", "Derecha", "No se\nidentifica", "NS/NR")),
         pos_id_w06 = factor(car::recode(c15_w06, recodes = "0:4 = 1; 5 = 2; 6:10 = 3; 11:12 = 4; c(-888, -999, -777, -666) = 5"),
                         levels = c(1, 2, 3, 4, 5),
                         labels = c('Izquierda', "Centro", "Derecha", "No se\nidentifica", "NS/NR"))) %>% 
  prop(pos_id_w06, by = c(pp_3, pos_id_w04)) %>%
...
```{r graf-pension, fig.cap = '"El Estado de Chile, más que los privados, debería ser el principal proveedor de educación", según tipo de votante'}
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) +
  ggtitle('', subtitle = 'De acuerdo o muy de acuerdo')
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  ggtitle('', subtitle = 'De acuerdo o muy de acuerdo con "Con la llegada de migrantes aumenta el desempleo"')
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  ggtitle('', subtitle = 'De acuerdo o muy de acuerdo con "Con la llegada de migrantes Chile pierde su identidad"')
