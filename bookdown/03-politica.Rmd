...
elsoc_long_2016_2022 <- elsoc_long_2016_2022 %>%
  left_join(perfiles, by = "idencuesta") %>%
   ...
   mutate(pp_4 = factor(pp_4, 
                       levels = 1:4,
                       labels = c("1 (8.30%)", "2 (64.24%)", "3 (14.28%)", "4 (13.17%)"))) %>%
   mutate(pp_5 = factor(pp_5, 
                       levels = 1:5,
                       labels = c("1 (4.73%)", "2 (63.24%)", "3 (14.27%)", 
                                  "4 (6.33%)", "5 (11.44%)")))
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  ggtitle('Posición política de centro',
...
elsoc_long_2016_2022 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) + 
  ggtitle('Ausencia de posición política',
...
elsoc_long_2016_2022 %>% 
  ...
  select(c05_03, c05_05, ola, ponderador02, segmento_disenno, estrato_disenno, salida) %>% 
