...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) + 
  labs(caption = "Nota: Clase social según ingresos fue construida según deciles de ingreso per cápita del hogar. Deciles 1-4 \ncorresponden a clase baja, deciles 5-9 a clase media y decil 10 a clase alta.")
...
elsoc_long_2016_2022 %>% 
  ...
  labs(caption = "Nota: El gráfico incluye a la muestra encuestada pre y post-plebiscito. La opción no vota solo fue incorporada\npost-plebiscito como voto retrospectivo.")
...
elsoc_long_2016_2022 %>% 
  ...
  geom_text(data = function(x) { group_by(.data = x, ola, pos_id) %>%
      ...
      'white', 'white', 'black')) +
  guides(fill = guide_legend(reverse = TRUE)) + 
  labs(caption = "Nota: Categoría indeciso o no vota incluye a quienes no votaron, no sabe, no responde, nulos y blancos.")
