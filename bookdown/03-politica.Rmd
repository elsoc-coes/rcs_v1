...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Sexo en 2022, según tipo de votante')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Tramos etarios en 2022, según tipo de votante')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Nivel educacional en 2022, según tipo de votante')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Situación laboral en 2022, según tipo de votante')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Clase social subjetiva en 2022, según tipo de votante')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Quintiles de ingreso en 2022, según tipo de votante')
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Clase social por ingreso en 2022, según tipo de votante')

```


```{r graf-clase-subj-ingreso}
elsoc_long_2016_2022 %>% 
  filter(tipo_atricion == 1) %>% 
...
elsoc_long_2016_2022 %>% 
  ...
  filter(tipo_atricion == 1, ola %in% 5:6) %>% 
      mutate(salida = factor(car::recode(salida, "1 = 1; 2 = 2; 3:5 = 3")),
         ...
         pos_id = factor(pos_id,
                         levels = 1:3,
                         labels = c("Apruebo", "Rechazo", "No votó o indeciso")),
             ola = factor(ola,
                          levels = 5:6,
                          labels = c("Plebiscito de\nEntrada\n2020",
                                     "Plebiscito de\nSalida\n2022"))) %>% 
...
elsoc_long_2016_2022 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  ggtitle('Desconfianza en la Convención Constitucional en 2022, según tipo de votante',
